...
class Config:
    ...
    # Footer
    FOOTER_COPYRIGHT_HTML: str = os.getenv("FOOTER_COPYRIGHT_HTML", 'Maintained by <a href="https://simula.no" class="text-ocean-400 hover:text-ocean-300">Simula</a></span>')
